/**
 * ============================================================================
 * PAGE CONNEXION / INSCRIPTION – ENTREPRISE
 * ============================================================================
 */
...
export default function EntrepriseConnexionPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/entreprise/auth/connexion', {
        method: 'POST',
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/entreprise/auth/inscription', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-white">
          {isRegistering ? 'Inscription Entreprise' : 'Espace Entreprise'}
        </h1>
        <p className="text-white/50 text-sm mt-1">
          {isRegistering ? 'Créez votre compte entreprise' : 'SIGDM – Portail Transport Logistique'}
        </p>
      </div>
      ...
      <div className="w-full max-w-md bg-white/8 backdrop-blur-sm border border-white/15 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="flex gap-2 mb-6 p-1 bg-white/5 rounded-xl">
          <button
            ...
            className={`flex-1 py-2 text-sm font-medium rounded-lg transition-colors ${
              !isRegistering ? 'bg-purple-600 text-white' : 'text-white/60 hover:text-white'
            }`}
          >
            Connexion
          </button>
        ...
        {isRegistering ? (
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1.5">Raison sociale *</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 outline-none transition-all"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 outline-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 outline-none"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 outline-none"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white font-semibold rounded-xl transition-all shadow-lg shadow-purple-600/30 mt-2"
            >
              {isLoading ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                  placeholder="contact@entreprise.ml"
                  required
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/30 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                  placeholder="••••••••"
                  required
                />
                <button
